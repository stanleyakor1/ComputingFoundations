...
class DoublyLinkedList:
    ...
    # this method return the index of an item in the list
    # I added this method to help me design the cache
    ...
    # This method will be helpful when we create the cache.
